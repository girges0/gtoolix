                ...
                <div class="gt-feature-visual-wrap">
                    ...
                    <div class="gt-mockup-card">
                        <div class="gt-highlight-tile">
                            ...
                            <span class="gt-parallax-badge" style="font-size: 0.75rem; color: #38BDF8; background: rgba(56, 189, 248, 0.15); border: 1px solid rgba(56, 189, 248, 0.3); padding: 0.2rem 0.6rem; border-radius: 9999px;">${isAr ? 'نشط' : 'Active'}</span>
                        </div>
                ...
                <div class="gt-feature-visual-wrap">
                    ...
                    <div class="gt-mockup-card">
                        <div class="gt-highlight-tile">
                            ...
                            <span class="gt-parallax-badge" style="font-size: 0.75rem; color: #C084FC; background: rgba(168, 85, 247, 0.15); border: 1px solid rgba(168, 85, 247, 0.3); padding: 0.2rem 0.6rem; border-radius: 9999px;">${isAr ? 'دليل' : 'Guide'}</span>
                        </div>
                ...
                <div class="gt-feature-visual-wrap">
                    ...
                    <div class="gt-mockup-card">
                        <div class="gt-highlight-tile">
                            ...
                            <span class="gt-parallax-badge" style="font-size: 0.75rem; color: #4ADE80; background: rgba(34, 197, 94, 0.15); border: 1px solid rgba(34, 197, 94, 0.3); padding: 0.2rem 0.6rem; border-radius: 9999px;">${isAr ? 'مفحوص' : 'Verified'}</span>
                        </div>
